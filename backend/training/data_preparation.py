...
class DataPreparationService:
    ...
    def create_document_qa_examples(
        ...
        for section in sections[:num_questions]:
            ...
            example = TrainingExample(
                ...
                metadata={"source": "document_qa", **(document_metadata or {})},
            )
    ...
    def create_summarization_examples(
        ...
        return TrainingExample(
            input_text=prompt,
            output_text=summary,
            metadata={"source": "summarization", **(document_metadata or {})},
        )
    ...
    def prepare_dataset(
        ...
        logger.info(
            f"Prepared {len(dataset)} training examples in {output_format} format"
        )
        return dataset

    def save_dataset(
        self, dataset: List[Dict[str, Any]], output_path: str, format: str = "jsonl"
    ) -> None:
    ...
    def _generate_question_prompt(
        self, section: str, metadata: Optional[Dict[str, Any]] = None
    ) -> str:
