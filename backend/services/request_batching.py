...
class RequestBatcher:
    ...
    def set_batch_processor(
        self, processor: Callable[[List[BatchRequest]], List[BatchResult]]
    ) -> None:
    ...
    async def _process_batch(self) -> None:
                ...
                for req in requests:
                    ...
                    if prompt_hash in self._request_hashes:
                        self._request_hashes[prompt_hash] = [
                            rid
                            for rid in self._request_hashes[prompt_hash]
        ...
        try:
            if self._batch_processor:
                ...
                for req in requests:
                    req.future.set_exception(Exception("Batch processor not configured"))
...
class MemoizationCache:
    ...
    def __init__(self, max_size: int = 1000, default_ttl_seconds: float = 3600.0):
