...
class LLMConfig:
    ...
    local_model: str = "llama3.1:8b"  # Updated to use available model
...
class FreeLLMService:
    ...
    def __init__(self, config: LLMConfig = None):
        ...
        self.deepseek_api_key = (
            os.getenv("DEEPSEEK_API_KEY") or self.config.deepseek_api_key
        )
    ...
    async def _call_ollama_local(self, prompt: str, **kwargs) -> str:
        ...
        try:
            ...
            result = await loop.run_in_executor(
                None, lambda: self.ollama_client.invoke(prompt)
            )
            return result
            ...
            try:
                ...
                result = await loop.run_in_executor(
                    None, lambda: fallback_client.invoke(prompt)
                )
                return result
    ...
    async def generate_response(
        self, prompt: str, use_cloud: bool = None, **kwargs
    ) -> str:
...
""",
        ...
        try:
            ...
            return {"error": str(e), "analysis_type": analysis_type, "status": "failed"}
...
"""
        ...
        try:
            ...
            try:
                ...
                return {"insights": response, "source_data": document_data}
