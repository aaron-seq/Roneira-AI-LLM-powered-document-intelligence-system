...
class AzureDocumentIntelligenceService:
    ...
    async def initialize(self):
        ...
        async with self._initialization_lock:
            ...
            try:
                ...
                if not key or not endpoint:
                    logger.warning(
                        "Azure Document Intelligence credentials not configured. Skipping init."
                    )
                    return
    ...
    async def analyze_document_from_file(
        self, file_path: str, model_id: str = "prebuilt-document"
    ) -> Dict[str, Any]:
        """
    ...
    async def analyze_document_from_content(
        self, document_content: bytes, model_id: str = "prebuilt-document"
    ) -> Dict[str, Any]:
        """
    ...
    def _structure_analysis_result(
        self, result: AnalyzeResult, processing_time: float
    ) -> Dict[str, Any]:
        """
